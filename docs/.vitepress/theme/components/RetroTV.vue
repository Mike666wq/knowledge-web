<script setup>
// 复古电视（改造自 Uiverse Stefan Devai 设计的网络错误小电视）
// 实功能：屏幕信息自动轮播（4s）+ 点击切换，电视带雪花静电动画
...
function next() { index.value = (index.value + 1) % messages.length }
</script>

<template>
  <div class="tv-stage" @click="next" title="点击换一句">
          ...
          <div class="display_div">
            <div class="screen_out">
              <div class="screen_out1">
                <div class="screen">
                  <span class="notfound_text">{{ current }}</span>
                </div>
              </div>
            </div>
          </div>
...
.tv-stage {
  ...
  cursor: pointer;
  font-size: 12px; /* em 单位基准，让电视保持 ~360px 见方 */
}
...
.text_404, .text_4041, .text_4042, .text_4043 { display: none; }
</style>
