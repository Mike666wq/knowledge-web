...
```bash
[root@localhost ~]# docker save nginx:latest -o nginx.tar
[root@localhost ~]# ll -lh
-rw-------  1 root root 63M Jul 14 01:09 nginx.tar
[root@localhost ~]# gzip nginx.tar 
[root@localhost ~]# ll -lh
-rw-------  1 root root 61M Jul 14 01:09 nginx.tar.gz
```
